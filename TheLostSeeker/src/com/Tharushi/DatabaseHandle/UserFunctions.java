package com.Tharushi.DatabaseHandle;
...
public class UserFunctions {
    ...
    //URL of the PHP API
    private static String loginURL = "http://10.0.2.2/thelostseekerAPI/";
    ...
    public JSONObject forPass(String forgotpassword){
      ...
      **/
    public JSONObject registerUser(String username,String password, String email,  String telephone,String address){
        // Building Parameters
        List<NameValuePair> params = new ArrayList<NameValuePair>();
