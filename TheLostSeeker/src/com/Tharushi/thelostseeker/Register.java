...
public class Register extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inputTelephone = (EditText) findViewById(R.id.edtelephone);
		inputAddress = (EditText) findViewById(R.id.edaddress);
	...
	private class ProcessRegister extends AsyncTask<String, String, JSONObject> {
		...
		String username, password,email,telephone, address;
		...
		protected JSONObject doInBackground(String... args) {
			...
			JSONObject json = userFunction.registerUser( username, password, email,telephone,address);
