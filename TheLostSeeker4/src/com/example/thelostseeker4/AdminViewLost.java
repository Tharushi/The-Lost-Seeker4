...
public class AdminViewLost extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setContentView(R.layout.testlist);
    	...
    	JsonReadTask mDoPOST = new JsonReadTask(AdminViewLost.this, strcategory);
     ...
     //   setListAdapter((ListAdapter) new CheckboxAdapter(ctx,R.layout.list_item,options));
	...
	public void ListDrwaer() throws IOException {
		...
		try {
			...
			for (int i = 0; i < jsonMainNode.length(); i++) {
			 ...
			 String outputtt = "Lost ItemID" + "-" + nameID + "\nCategory"
						+ "-" + namecategory+ "\nDescription"
						+ "-" + named + "\nLost Location" + "-" + namel + "\nColour"
						+ "-" + namec+ "\nLost Date"+"-"+namedate;
